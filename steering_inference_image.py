...
class SteeringNode(Node):
    def __init__(self):
        ...
        self.sub = self.create_subscription(CompressedImage, '/image/compressed', self.image_callback, qos)
        ...
        self.tf = T.Compose([
            ...
            lambda pil: pil.crop((0, int(0.2 * pil.height), pil.width, pil.height)),
            T.Resize((224, 224)),
            T.ToTensor(),
    ...
    def worker_loop(self):
        ...
        while rclpy.ok():
            ...
            # Decode the incoming compressed image into a CV2 image
    ...
    def publish_cmd(self):
        ...
        vel_cmd.angular.z = self.latest_omega
